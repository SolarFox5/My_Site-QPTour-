document.addEventListener('DOMContentLoaded', function () {
    ...
    const places = [
        ...
        { name: 'Екатеринбург', lat: 56.8431, lng: 60.6454, description: 'Столица Урала' },
        ...
        { name: 'Абхазия', lat: 42.8766, lng: 41.1066, description: 'Республика на побережье Черного моря' },
